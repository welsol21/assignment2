...
class EmployeeServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.GetEmployeeDetails = channel.unary_unary(
...
def add_EmployeeServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetEmployeeDetails': grpc.unary_unary_rpc_method_handler(
                    servicer.GetEmployeeDetails,
    ...
    server.add_registered_method_handlers('EmployeeService', rpc_method_handlers)
